(defproject rn-commonjs "0.1.0-SNAPSHOT"
  ...
  {:builds
   [{:source-paths ["src"]
     :compiler
                   {:foreign-libs
                    [{:file        "Libraries/ActionSheetIOS/ActionSheetIOS.js",
                      :provides    ["ActionSheetIOS"],
                      :requires    ["NativeModules" "invariant"],
                      :module-type :commonjs}
                     {:file        "Libraries/AdSupport/AdSupportIOS.js",
                      :provides    ["AdSupportIOS"],
                      :requires    ["NativeModules"],
                      :module-type :commonjs}
                     {:file        "Libraries/Animation/AnimationExperimental.js",
                      :provides    ["AnimationExperimental"],
                      :requires    ["NativeModules" "React" "AnimationUtils"],
                      :module-type :commonjs}
                     {:file        "Libraries/Animation/AnimationUtils.js",
                      :provides    ["AnimationUtils"],
                      :requires    [],
                      :module-type :commonjs}
                     {:file        "Libraries/Animation/LayoutAnimation.js",
                      ...
                      :requires    ["ReactPropTypes"
                                    ...
                                    "keyMirror"],
                      :module-type :commonjs}
                     {:file        "Libraries/Animation/POPAnimationMixin.js",
                      :provides    ["POPAnimationMixin"],
                      :requires    ["POPAnimation" "React" "invariant" "warning"],
                      :module-type :commonjs}
                     {:file        "Libraries/AppRegistry/AppRegistry.js",
                      :provides    ["AppRegistry"],
                      :requires    ["invariant" "renderApplication" "RCTRenderingPerf"],
                      :module-type :commonjs}
                     {:file        "Libraries/AppStateIOS/AppStateIOS.android.js",
                      :provides    ["AppStateIOS.android"],
                      :requires    ["warning"],
                      :module-type :commonjs}
                     {:file        "Libraries/AppStateIOS/AppStateIOS.ios.js",
                     ...
                     {:file        "Libraries/ART/ReactNativeART.js",
                      ...
                      :requires    ["art/core/color"
                                    ...
                                    "merge"],
                      :module-type :commonjs}
                     {:file        "Libraries/BatchedBridge/BatchedBridgedModules/__mocks__/NativeModules.js",
                      :provides    ["NativeModules"],
                      :requires    [],
                      :module-type :commonjs}
                     {:file        "Libraries/BatchedBridge/BatchedBridgedModules/NativeModules.js",
                      :provides    ["NativeModules"],
                      :requires    ["BatchedBridge" "nativeModulePrefixNormalizer"],
                      :module-type :commonjs}
                     {:file        "Libraries/BatchedBridge/BatchedBridgedModules/POPAnimation.js",
                      ...
                      :requires    ["NativeModules"
                                    ...
                                    "merge"],
                      :module-type :commonjs}
                     {:file        "Libraries/BatchedBridge/BatchedBridgedModules/RCTAlertManager.ios.js",
                      :provides    ["RCTAlertManager.ios"],
                      :requires    ["NativeModules"],
                      :module-type :commonjs}
                     {:file        "Libraries/BatchedBridge/BatchedBridgedModules/RCTEventEmitter.js",
                      :provides    ["RCTEventEmitter"],
                      :requires    ["ReactNativeEventEmitter"],
                      :module-type :commonjs}
                     {:file        "Libraries/BatchedBridge/BatchedBridgedModules/RCTJSTimers.js",
                      :provides    ["RCTJSTimers"],
                      :requires    ["JSTimersExecution"],
                      :module-type :commonjs}
                     {:file        "Libraries/BatchedBridge/BatchingImplementation/BatchedBridge.js",
                      :provides    ["BatchedBridge"],
                      :requires    ["BatchedBridgeFactory" "MessageQueue"],
                      :module-type :commonjs}
                     {:file        "Libraries/BatchedBridge/BatchingImplementation/BatchedBridgeFactory.js",
                     ...
                     {:file        "Libraries/CameraRoll/CameraRoll.js",
                      ...
                      :requires    ["ReactPropTypes"
                                    ...
                                    "invariant"],
                      :module-type :commonjs}
                     {:file        "Libraries/Components/ActivityIndicatorIOS/ActivityIndicatorIOS.ios.js",
                      :provides    ["ActivityIndicatorIOS.ios"],
                      :requires    ["NativeMethodsMixin"
                                    "ReactPropTypes"
                                    "React"
                                    "StyleSheet"
                                    "View"
                     ...
                     {:file
                      ...
                      :module-type :commonjs}
                     {:file
                                   "Libraries/react-native-interface.js",
                      :provides    ["react-native-interface"],
                      :requires    [],
                      :module-type :commonjs}
                     {:file
                                   "Libraries/react-native.js",
